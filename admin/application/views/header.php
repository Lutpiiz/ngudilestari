...
<body style="background-color: #fafafa;">
    ...
    <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #307e32;">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url('welcome') ?>"><img src="<?php echo $this->config->item('url_image') . 'Agriculture Logo.png'; ?>" alt="" width="50px" class="me-3"><span style="font-weight: 600;">Admin Ngudi Lestari</span></a>
