...
<body style="background-color: #fafafa;">
    ...
    <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #307e32;">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url('welcome') ?>"><img src="<?php echo $this->config->item('url_image') . 'logo1.png'; ?>" alt="" width="50px" class="me-3"><span style="font-weight: 600;">Kelompok Tani Ngudi Lestari</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('lahan') ?>">Lahan</a>
                    </li>
                    <li class="nav-item">
